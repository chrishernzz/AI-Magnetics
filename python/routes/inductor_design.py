...
def _serialize_turns_and_gap(t) -> dict:
    return {
        ...
        "loadedInductanceUH": t.loadedInductanceUH,
    }
...
#precondition: b is a valid BottleneckAnalysis object
#postcondition: returns a serializable bottleneck dictionary; reason enum is converted to string
def _serialize_bottleneck(b) -> dict:
    return {
        "reason": b.reason.name,
        "limitingCheckName": b.limitingCheckName,
        "explanation": b.explanation,
        "marginValue": b.marginValue,
        "marginValueApplicable": b.marginValueApplicable,
    }
...
def _serialize_candidate(c) -> dict:
    return {
        ...
        "bottleneck": _serialize_bottleneck(c.bottleneck),
        "designNarrative": c.designNarrative,
    }
...
def _serialize_ranking_highlights(h) -> dict:
    return {
        "hasCandidates": h.hasCandidates,
        "thermalBestPartNumber": h.thermalBestPartNumber,
        "lowestLossPartNumber": h.lowestLossPartNumber,
        "highestSaturationMarginPartNumber": h.highestSaturationMarginPartNumber,
