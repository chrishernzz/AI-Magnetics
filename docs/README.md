...
- ✅ Saturation flux density (`BmaxT`) — real, material-specific data for all 165 materials in the current snapshot; `SaturationValidation`/`PeakFluxValidation` use it automatically instead of the Phase 1 default
